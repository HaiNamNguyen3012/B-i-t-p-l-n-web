...
<body>
  <form method="post">
      ...
      <ul>
        <li>
          <a href="index.php?controller=post_details&action=showPost&id=' . $post->id_phong . '">Tiêu đề</a>
          <ul>
            <li>ID :123456</li>
            <li>Giá: 3 triệu</li>
            <li>Loại phòng: Chung cư mini</li>
            <li>Diện tích: 20 m<sup>2</sup></li>
            <li>Đăng bởi: Trần Huy</li>
            <li>Hà Nội</li>
            <li>Ba Đình</li>
            <li>Xã phường</li>
            <li>Ảnh: </li>
